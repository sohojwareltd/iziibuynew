        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-success float-right" href="{{ route('tickets.create') }}"><i class="fas fa-plus"></i> {!! __('words.ticket_new') !!}</a>
                        ...
                        <tbody x-data="orderable" id="container">
                            ...
                            <tr class="dragable">
                                ...
                                <td>
                                    ...
                                    <a class="btn {{ $ticket->status ? 'btn-danger' : 'btn-success' }} py-1" href="{{route('ticket.close',$ticket)}}">{{ $ticket->status ? 'Close' :'Open' }}</a>
