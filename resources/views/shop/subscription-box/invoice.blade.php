            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        <button onclick="printDiv('printableArea')" class="btn btn-inline"><i class="fa fa-print"></i> Skriv
                            ut</button>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <p><b>{!! __('words.invoice_place') !!} :</b>{{ $order->city }}</p>
                                            <p><b>{!! __('words.invoice_country') !!} :</b>{{ $order->state }}</p>
                                            <p><b>{!! __('words.invoice_postcode') !!}:</b>{{ $order->post_code }}</p>
