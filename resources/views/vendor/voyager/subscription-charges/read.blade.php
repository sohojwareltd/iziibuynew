...
@section('page_header')
    ...
    <h1 class="page-title hidden-print">
        ...
        <a href="{{ route('voyager.' . $dataType->slug . '.invoice', $dataTypeContent->getKey()) }}" class="btn btn-success">
                        ...
                        <div class="col-md-3 transiction-info">
                            ...
                            <p class="trans-data"> <span class="glyphicon glyphicon-ok"></span>
                                @if (isset($transiction->card) && $transiction->card)
                                    {{ $transiction->card->bin ?? 'N/A' }} *** {{ $transiction->card->last4 ?? 'N/A' }}
                                @else
                                    N/A
                                @endif
                            </p>
            ...
            <div class="card border-radius">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="transiction-info">
                            <p>Requting</p>
                            @if (isset($transiction->recurring) && $transiction->recurring == true)
