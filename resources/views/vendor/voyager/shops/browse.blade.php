                    ...
                    <div class="panel-body">
                        ...
                        <div class="card">
                            <div class="card-body mb-2">
                                ...
                                <form action="{{ route('admin.shops.import') }}" enctype="multipart/form-data"
                                    method="post">
                                    @csrf
                                    <div class="form-group">
                                        <input type="file" name="sheet" id="" class="form-control">
                                    </div>
                                    <p>
                                    ...
                                    ">
                                        ...
                                        <a href="{{ asset('shop_import_demo.xlsx') }}" class="btn btn-info">Demo Excel </a>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                            ...
                                            @endif
                                            <td
                                                onclick="copyToclipboard(`{{ route('shop.home', ['user_name' => $data->user_name]) }}`)">
                                                <x-qr.direct :size="100" :url="route('shop.home', ['user_name' => $data->user_name])" :disabled="true" />
                                            </td>
                                            @foreach ($dataType->browseRows as $row)
                                                @php
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                ...
                                                <a target="_blank" style="margin-right: 4px"
                                                    href="{{ route('shop.home', ['user_name' => $data->user_name]) }}"
                                                    title="browse" class="btn btn-sm btn-primary pull-right edit">
                                                    <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">Visit
                                                        Shop</span>
                                                </a>
                                                <a target="_blank" style="margin-right: 4px"
                                                    href="{{ route('advance.shop.edit', $data->id) }}"
                                                    title="Advance Edit" class="btn btn-sm btn-primary pull-right edit">
                                                    <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">Advance Edit
                                                        </span>
                                                </a>
                                                <a target="_blank" style="margin-right: 4px"
                                                    href="{{ url('admin/products?key=shop_id&filter=equals&s=' . $data->user_name) }}"
                                                    title="browse" class="btn btn-sm btn-warning pull-right edit">
                                                    <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">Product
                                                        List</span>
                                                </a>
                                                <a target="_blank" style="margin-right: 4px"
                                                    href="{{ \App\Filament\Resources\Users\UserResource::getUrl(panel: 'admin') }}"
                                                    title="browse" class="btn btn-sm btn-danger pull-right edit">
                                                    <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">Edit
                                                        Owner
                                                        Profile</span>
                                                </a>
                                                <a target="_blank" style="margin-right: 4px"
                                                    href="{{ route('admin.shop_product_export_by_admin', $data->id) }}"
                                                    title="browse" class="btn btn-sm btn-primary pull-right edit">
                                                    <i class="voyager-dot-3"></i> <span class="hidden-xs hidden-sm">Export
                                                        Products</span>
                                                </a>
