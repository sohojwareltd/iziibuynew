...
@section('content')
    ...
    <div class="page-content browse container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="panel panel-bordered" style="border-radius:10px;overflow:hidden">
                    <div class="panel-body bg-info">
                        <div style="display: flex;justify-content:space-between;width:100%">
                            <h1>{{ App\Models\Shop::where('is_demo', false)->count() }}</h1>
                            <a href="https://iziibuy.com/admin/shops?key=is_demo&filter=equals&s=0">View</a>
                        </div>
                        <h3 style="float:right">Live Shops</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-bordered" style="border-radius:10px;overflow:hidden">
                    <div class="panel-body bg-info">
                        <div style="display: flex;justify-content:space-between;width:100%">
                            <h1>{{ App\Models\Shop::where('is_demo', true)->count() }}</h1>
                            <a href="https://iziibuy.com/admin/shops?key=is_demo&filter=equals&s=1">View</a>
                        </div>
                        <h3 style="float:right">Demo Shops</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-bordered" style="border-radius:10px;overflow:hidden">
                    <div class="panel-body  @if (request()->s == 'Real') bg-success @else bg-info @endif ">
                        <div style="display: flex;justify-content:space-between;width:100%">
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                ...
                                                @if ($data->details)
                                                    <button type="button" class="btn btn-primary btn-lg"
                                                        ...
                                                        onclick="setdetails(this)" data-details="{{ $data->details }}">
                                                        See Details
                                                    </button>
                                                @endif
                                            </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modalLabel">Charge Information</h4>
                </div>
