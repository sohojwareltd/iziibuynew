...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('edit', app($dataType->model_name))
            ...
            @endif
        @endcan
        <a href="{{ route('admin.enterprise_onboarding_export') }}" class="btn btn-info btn-add-new">
            <i class="voyager-download"></i> <span>Export Onboardings</span>
        </a>
        @can('delete', app($dataType->model_name))
            @if ($usesSoftDeletes)
                                        ...
                                        <tr>
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                @foreach ($actions as $action)
                                                    ...
                                                    @endif
                                                @endforeach
                                                <a href="{{ route('admin.enterprise_onboarding_export_single', $data->getKey()) }}"
                                                    title="Download" class="btn btn-sm btn-info pull-right" style="margin-right: 5px;">
