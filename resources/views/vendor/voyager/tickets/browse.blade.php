...
@section('content')
    <div class="page-content browse container-fluid">
        ...
        <div class="row">
            ...
            <input type="hidden" name="order_by" value="action">
             <div class="row">
                <div class="col-md-4">
                <Select name="s" class="form-control ">
                <option value="">Choose us..</option>
                <option value="0">Need reply admin</option>
                <option value="1"> Need reply from customer</option>
            </Select>
                </div>
                <div class="col-md-2">
...
@section('javascript')
    ...
    <script>
        ...
        $('td').on('click', '.delete', function (e) {
            $('#delete_form')[0].action = '{{ filament_panel_url() }}'.replace('__id', $(this).data('id'));
            ...
            $(function() {
                $('#show_soft_deletes').change(function() {
                    if ($(this).prop('checked')) {
                        $('#dataTable').before('<a id="redir" href="{{ (filament_panel_url()) }}"></a>');
                    }else{
                        $('#dataTable').before('<a id="redir" href="{{ (filament_panel_url()) }}"></a>');
                    }
