...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ filament_panel_url() }}" class="btn btn-success ">
                <i class="voyager-plus"></i> <span>{{ __('voyager::generic.add_new') }}</span>
            </a>
            <a href="{{route('admin.languages.download')}}" class="btn btn-info ">
        ...
        @can('edit', app($dataType->model_name))
            @if (!empty($dataType->order_column) && !empty($dataType->order_display_column))
                <a href="{{ filament_panel_url() }}" class="btn btn-primary ">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group mb-5">
                                    <label for="formFile" class="form-label">Translation Import</label>
                                    <input class="form-control" required name="sheet" type="file" id="formFile"
                                        style="padding: 5px">
                                </div>
