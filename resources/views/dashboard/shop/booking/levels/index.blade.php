        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-success float-right" href="{{ route('shop.package.levels.create') }}"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-sm mt-1"
                                            href="{{ route('shop.package.levels.edit', $level) }}"><i
                                                class="fas fa-edit"></i></a>

                                        <x-helpers.delete :url="route('shop.package.levels.destroy', $level)" :id="$level->id" />
