<x-dashboard.shop>
    ...
    <div class="container mt-5">
        <form action="{{ route('shop.store_setup_elavon_payment') }}" method="post">
            @csrf
            <fieldset class="scheduler-border">
                ...
                <div class="form-group">
                    ...
                    <x-form.input type="text" label="{{ __('words.legal_name') }}" :value="$shop->name" name="meta[name]"
                        id="legalName" />
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <x-form.input type="text" label="{{ __('words.business_address') }}" :value="$shop->address"
                            name="meta[businessAddress]" id="businessAddress" required />

                    </div>

                    <div class="form-group col-md-6">
                        <x-form.input type="tel" label="{{ __('words.telephone_number') }}" :value="$shop->contact_phone"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <x-form.input type="text" :value="$shop->user->fullName"
                    ...
                    <div class="form-group col-md-6">
                        <x-form.input type="email" label="{{ __('words.email') }}" :value="$shop->contact_email"
                            name="meta[contact_email]" readonly id="email" required />

                    </div>
                </div>

                <div class="form-group">
                    <x-form.input type="text" label="{{ __('words.outlet_name') }}" :value="$shop->company_name"
                        name="meta[company_name]" id="outletName" required />

                </div>

                <div class="form-group">
                    <x-form.input type="text" :value="$shop->address" label="{{ __('words.outlet_address') }}"
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <x-form.input type="text" label="{{ __('words.domainIfAvailable') }}"
                            name="meta[trading][domain]" id="domain" required />
            ...
            <fieldset class="scheduler-border">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <x-form.input type="text" label="{{ __('words.organization_number') }}" :value="$shop->company_registration"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <x-form.input type="text" label="{{ __('words.per_transaction_fee') }}"
                            name="meta[productId][per_transaction_fee]" id="per_transaction_fee" value="2.49%"
                            readonly />
                    </div>
                </div>
            </fieldset>
