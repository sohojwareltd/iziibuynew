                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="center" class="alignment"
                                                                        style="line-height:10px"><img
                                                                            alt="{{ $charge->shop->user_name }}"
                                                                            src="{{ Iziibuy::image($charge->shop->logo) }}"
                                                                ...
                                                                <td class="pad">
                                                                    <div style="font-family: Georgia, serif">
                                                                        <div class=""
                                                                            ...
                                                                            <h5 style="text-align: center;margin-top:20px;margin-bottom:10px">#{{$charge->order_id}}</h5>
                                                                            <p
                                                                                style="margin: 0; margin-top:10px; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
                                                                                <span
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                {{ $charge->shop->company_name }}
                                                                            </p>
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                                                <b>{{ __('words.invoice_tax') }}</b>
                                                                                {{ $charge->shop->company_registration }}
                                                                            </p>
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
