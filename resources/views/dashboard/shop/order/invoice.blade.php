<x-dashboard.shop>
        ...
        <div class="card">
            ...
            <div class="card-body d-flex justify-content-center" id="printableArea">
                <div class=""  style="background-color: #fff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none; ">
                                                    ...
                                                    <tr>
                                                        <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                            <div align="center" class="alignment" style="line-height:10px"><img
                                                                    ...
                                                                    title="Light blue sphere with flowers" width="272" /></div>
                                                        </td>
                                                    </tr>
                                                </table>
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                <div class=""
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <b>{{ __('words.company') }}:</b> {{ $order->shop->company_name }}</p>
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                                        <b>{{ __('words.invoice_tax') }}</b> {{ $order->shop->company_registration }}</p>
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                                        <b>{{ __('words.invoice_address') }}:</b> {{ $order->shop->street }}</p>
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                                        <b>{{ __('words.invoice_place') }}:</b>  {{ $order->shop->post_code }} {{ $order->shop->city }}</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td class="pad">
                                                            <div style="font-family: sans-serif">
                                                                <div class=""
                                                                    ...
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                                        {{ __('words.email_hi') }} {{ $order->first_name }} {{ $order->last_name }}</p>
                                                                    <p
                                                        ...
                                                        <td class="pad"
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                <div class=""
                                                                    ...
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                        {{ __('words.date') }}: {{ $order->created_at->format('M d, Y') }}</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            {{__('words.dashboard_sku')}}: {{ $product->sku }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <td class="pad"
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                <div class=""
                                                                    ...
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                        <span style="font-size:16px;"><strong>{{__('words.subscription_ex_vat')}}</strong></span>
                                                                    </p>
                                                            </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="pad"
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                <div class=""
                                                                    ...
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                        <span style="font-size:16px;"><strong>{{ __('words.cart_tax') }}</strong></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="pad"
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                <div class=""
                                                                    ...
                                                                    <p
                                                                        style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                        <span style="font-size:16px;"><strong>{{ __('words.cart_account_table_title') }}</strong></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 16.8px;">
                                                                            <span
                                                                                style="font-size:16px;">{{ Iziibuy::price($order->shipping_cost, $order->shop) }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                        ...
                                                                        <td class="pad"
                                                                            ...
                                                                            <div style="font-family: sans-serif">
                                                                                ...
                                                                                <div class=""
                                                                                    ...
                                                                                    <p
                                                                                        style="margin: 0; font-size: 14px;  mso-line-height-alt: 21px;">
                                                                                        {{ __('words.email_thankyou_pera') }}</p>
                                                                                    <p
                                                                                        style="margin: 0; font-size: 14px;  mso-line-height-alt: 21px;">
