<x-dashboard.enterprise>
    ...
    <div class="container mt-5">
        <form action="{{ route('enterprise.store_setup_elavon_payment') }}" method="post">
            @csrf
            <fieldset class="scheduler-border">
                ...
                <div class="form-group">
                    ...
                    <x-form.input type="text" label="{{ __('words.legal_name') }}" :value="$enterprise->user->fullName" name="meta[name]"
                        id="legalName" />
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <x-form.input type="text" label="{{ __('words.business_address') }}" :value="$enterprise->addressFull"
                            name="meta[businessAddress]" id="businessAddress" required />

                    </div>

                    <div class="form-group col-md-6">
                        <x-form.input type="tel" label="{{ __('words.telephone_number') }}" :value="$enterprise->user->phone"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <x-form.input type="text" :value="$enterprise->user->fullName"
                    ...
                    <div class="form-group col-md-6">
                        <x-form.input type="email" label="{{ __('words.email') }}" :value="$enterprise->company_email"
                ...
                <div class="form-group">
                    <x-form.input type="text" label="{{ __('words.outlet_name') }}" :value="$enterprise->company_name"
                        name="meta[company_name]" id="outletName" required />

                </div>

                <div class="form-group">
                    <x-form.input type="text" :value="$enterprise->addressFull" label="{{ __('words.outlet_address') }}"
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <x-form.input type="text" label="{{ __('words.domainIfAvailable') }}"
                            name="meta[trading][domain]" id="domain" required :value="$enterprise->company_domain" />
            ...
            <fieldset class="scheduler-border">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <x-form.input type="text" label="{{ __('words.organization_number') }}" :value="$enterprise->company_registration"
