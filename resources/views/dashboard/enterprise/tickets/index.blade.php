        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-success float-right" href="{{ route('enterprise.tickets.create') }}"><i class="fas fa-plus"></i> {!! __('words.ticket_new') !!}</a>
                        ...
                        <tbody x-data="orderable" id="container">
                            ...
                            <tr class="dragable">
                                ...
                                <td>
                                    ...
                                    <a title="Product List" class="btn btn-info btn-sm" href="{{ route('external.tickets.show',$ticket) }}"><i class="fa fa-eye"></i></a>

                                    <a class="btn {{ $ticket->status ? 'btn-danger' : 'btn-success' }} py-1" href="{{route('external.ticket.close',$ticket)}}">{{ $ticket->status ? 'Close' :'Open' }}</a>
