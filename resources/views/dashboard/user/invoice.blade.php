                    ...
                    <div class="card-body " id="printableArea">
                        <div class="d-flex justify-content-center">
                            <div class="padding"
                                                                                    ...
                                                                                    <p
                                                                                        ...
                                                                                        @php
                                                                                            if ($order->status == 5) {
                                                                                                ...
                                                                                                $color = "#555";
                                                                                                $subject = __('words.payment_confirmed_email_subject');
                                                                                            }elseif($order->status == 3){
                                                                                                $color = "#ff8297";
                                                                                                $subject = __('words.order_status_canceled_title');
                                                                                            }elseif($order->status == 0){
                                                                                                $color = "#aba1e6";
                                                                                                $subject = __('words.order_status_pending_title');
                                                                                            }
                                                                                            
                                                                                        @endphp
                                                                                        <span
                                                                                            style="font-size:20px; font-weight:777; background-color: {{$color}};padding:5px 20px; border:1px solid #555;border-radius:10px">  {{ $subject }}</span>
                                                                                    </p>
                                                                        ...
                                                                        <td class="pad p-3">
                                                                            <div style="font-family: sans-serif">
                                                                                <div class=""
                                                                                    ...
                                                                                    <p
                                                                                        style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                                                        <b>{{ __('words.org_number') }}</b>
                                                                                        {{ $order->shop->company_registration }}
                                                                                    </p>
                                                                                    <p
                                                                                        style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                                                        <b>{{ __('words.org_email') }}:</b>
                                                                                        {{ $order->shop->street }}
                                                                                    </p>
                                                                                    <p
                                                                                        style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                    class="row row-7" role="presentation"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                    <tbody>
                                        <tr>
                                            <td>
                                ...
                                @foreach ($order->products as $product)
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row row-12" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <table align="center" border="0" cellpadding="0"
                                                        cellspacing="0" class="row-content" role="presentation"
                                                            ...
                                                            <tr>
                                                                <td class="column column-1"
                                                                    ...
                                                                    <table border="0" cellpadding="0"
                                                                        cellspacing="0" class="text_block block-2"
                                                                        role="presentation"
                                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;"
                                                                        width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td class="pad"
                                                                                ...
                                                                                <div style="font-family: sans-serif">
                                                                                    <div class=""
                                                                                        ...
                                                                                        <p
                                                                                            style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 16.8px;">
                                                                                            {{ Iziibuy::price($product->pivot->price, $order) }}
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                    class="row row-15" role="presentation"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                    <tbody>
                                        <tr>
                                            <td>
                                ...
                                @if ($order->discount > 0)
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row row-16" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tbody>
                                            <tr>
                                                <td>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="column column-2"
                                                                    ...
                                                                    width="33.333333333333336%">
                                                                    <table border="0" cellpadding="0"
                                                                        cellspacing="0" class="empty_block block-2"
                                                                        role="presentation"
                                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                                        width="100%">
                                                                        <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="column column-1"
                                                                    ...
                                                                    width="100%">
                                                                    <table border="0" cellpadding="0"
                                                                        cellspacing="0" class="divider_block block-1"
                                                                        role="presentation"
                                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                                        width="100%">
                                                                        <tr>
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                    class="row row-18" role="presentation"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                    <tbody>
                                        <tr>
                                            <td>
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                    class="row row-19" role="presentation"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                    <tbody>
                                        <tr>
                                            <td>
