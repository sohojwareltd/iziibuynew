                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        ...
                                                        src="{{ Voyager::image($order->shop->logo) }}"
                                                    ...
                                                    <div class=""
                                                        ...
                                                        <p
                                                            style="margin: 0; margin-top:10px; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
                                                                <span
                                                                    style="font-size:20px; font-weight:777; background-color:#dad8eb;padding:5px 20px; border:1px solid #555;border-radius:10px">{{ __('words.product_delivered_email_title') }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;text-align:center">
                                                        ...
                                                        <p
                                                            ...
                                                            {{ $order->shop->post_code }} {{ $order->shop->city }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            ...
                                                            {{ __('words.email_hi') }} {{ $order->first_name }}
                                                            {{ $order->last_name }}</p>
                                                        <p
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            ...
                                                            {{ __('words.kl') }}: {{ @$order?->paid_at?->format('H:i') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <td class="pad"
                                                    ...
                                                    <div style="font-family: sans-serif">
                                                        <div class=""
                                                            ...
                                                            <p
                                                                style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 16.8px;">
                                                                {{ Iziibuy::withSymbol($product->pivot->price, $order->currency) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                            <span
                                                                style="font-size:16px;"><strong>{{ __('words.remaining_email_title') }}</strong></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 16.8px;">
                                                            <span
                                                                style="font-size:20px;font-weight:bold;">{{ Iziibuy::withSymbol(0, $order->currency) }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                @if ($order?->user?->post_code && $order?->user?->city)
                                                                    <div style="font-family: sans-serif">
                                                                        ...
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                style="margin: 0; font-size: 14px;  mso-line-height-alt: 21px;">
                                                                                {{ $order?->user?->post_code }} {{ $order?->user?->city }}
                                                                            </p>
                                                                            <p
                                                                                style="margin: 0; font-size: 14px;  mso-line-height-alt: 21px;">
                                                                                Tel: {{ $order?->user?->phone }}</p>
                                                                        </div>
                                                                        <div class=""
                                                                ...
                                                                @else
                                                                    <div style="font-family: sans-serif">
                                                                        <p
                                                                            style="margin: 0; padding-bottom:5px; font-size: 14px; font-weight:700;  mso-line-height-alt: 21px;">
                                                                            {{ __('words.shipping_address_not_found') }}
                                                                        </p>
                                                                    </div>
                                                                @endif
                                                            </td>
