                                            ...
                                            <td class="pad"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                            {{ Iziibuy::price($shop->establishedFee()) }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                            {{ Iziibuy::price($shop->monthlyFee()) }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                            {{ Iziibuy::price($shop->perUserFee()) }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                            {{ Iziibuy::price($shop->openingTax()) }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <td class="pad"
                                                    ...
                                                    <div style="font-family: sans-serif">
                                                        <div class=""
                                                            ...
                                                            <p
                                                                style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                                {{ Iziibuy::price(session('discount_shop')) }}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;">
                                                            {{ Iziibuy::price($shop->openingFee()) }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                    </tr>
