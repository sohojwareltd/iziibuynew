...
class TicketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.external.tickets.index', compact('tickets'));
    }
    ...
    {
        return view('dashboard.external.tickets.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('external.tickets.index')->withSuccess('Tickets create successfully');
        } catch (Exception $e) {
    ...
    {
        return view('dashboard.external.tickets.show', compact('ticket'));
    }
