...
class TicketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.enterprise.tickets.index', compact('tickets'));
    }
    ...
    {
        return view('dashboard.enterprise.tickets.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('enterprise.tickets.index')->withSuccess('Tickets create successfully');
        } catch (Exception $e) {
    ...
    {
        return view('dashboard.enterprise.tickets.show', compact('ticket'));
    }
