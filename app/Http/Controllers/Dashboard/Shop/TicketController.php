...
class TicketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.shop.tickets.index',compact('tickets'));
    }
    ...
    {
        return view('dashboard.shop.tickets.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tickets.index')->withSuccess('Tickets create successfully');
        } catch (Exception $e) {
    ...
    {
        return view('dashboard.shop.tickets.show',compact('ticket'));
    }
